...
\fig{ipglasma}{
  ...
  Both models use nucleon-nucleon cross section $\sigma_\text{NN}=6.4$~fm$^2$ and nucleon width $w=0.43$~fm.
...
Each \trento\ initial condition event is free streamed using the procedure in Ref.~\ref{?} for $\tau=0.4$~fm/c to mimic the weakly coupled pre-equilibrium dynamics of IP-Glasma and match the evolution time of both models.
