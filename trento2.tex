...
As the system expands and cools, the QGP medium undergoes hadronization and rescatters as a hadron resonance gas for a period of time before collisions cease and the system starts to break up. Eventually, the mean free path of the medium approaches the system size and the hydrodynamic description breaks down.  The hybrid model approach used in the present analysis accounts for these off equilibirum hadronic scatterings and kinetic freezeout using the UrQMD hadronic cascade. 
