...
Previous studies have applied Bayesian parameter estimation to simulations initialized with Monte Carlo Glauber (MC-Glb.) and Monte Carlo Kharzeev-Levin-Nardi (MC-KLN) initial conditions as well as constrained parametric forms of the QGP equation of state and initial conditions in an event-averaged hydrodynamic model. 


As of yet, there has been no effort to apply Bayesian methodology to parameterize and constrain fluctuating initial conditions within a saturation type picture.
