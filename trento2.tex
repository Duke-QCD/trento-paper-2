...
\begin{abstract}
  ...
  We show that initial entropy deposition is consistent with a saturation-based picture, extract a relation between the minimum value and slope of the specific shear viscosity, and find a clear signal for a finite bulk viscosity.
\end{abstract}
...
Examining the marginal distributions for $\eta/s$ min and slope, we see a clear preference for $(\eta/s)_\text{min} \lesssim 0.15$ and little preference for any particular slope within the considered range;
