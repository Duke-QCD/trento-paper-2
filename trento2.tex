...
First, nucleon positions for nuclei $A$ and $B$ are sampled from a standard uncorrelated Woods-Saxon distribution and shifted by $\pm b/2$, where $b$ is a minimum-bias impact parameter.
