...
Simulations based on relativistic viscous hydrodynamics have been highly successful describing a weath of bulk observables in heavy-ion collisions at RHIC and the LHC. Despite this success, there remains a large degree of uncertainty in modeling the initial stages of the collision. Typically, the initial conditions are calculated within an specific effective theory, subject to a number of assumptions and related approximations. The 
...
strongly interacting system of deconfined quarks and gluons known as a quark-gluon plasma (QGP). This discovery was evidenced by a number of surprising discoveries, most notably the existence of striking correlations in the azimuthal particle yields of high-energy nuclear collisions now understood to arise from the collective
expansion of a short-lived QGP liquid.

Relativistic viscous fluid dynamics has been highly successful in describing both qualitative and quantitative features of the collectivity observed in these collisions and has emerged as an effective mathematical framework to study QGP.

most notably the existence of azimuthal correlations in particle yields understood to arise
when particles are emitted from a commonly flowing source.

...and as such as emerged as standard simulation framework to model the evolution

% state the goal/value of hydro modeling, why do it?
Fluid dynamic simulations provide an important link between intrinsic properties of short-lived QGP medium such as its equation of state and hydrodynamic transport coefficients and extrinsic observables which characterize the asymptotic state of the system as measured by experiment. 
