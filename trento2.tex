...
\begin{figure}
    ...
    \caption{Sampled curves of the temperature dependent shear viscosity $(\eta/s)(T)$ (top panel) and temperature dependent bulk viscosity $(\zeta/s)(T)$ (bottom panel) drawn from the
        the posterior distributions on $\eta/s$ min, $\eta/s$ slope and $\zeta/s$ norm in Fig.~\ref{fig:posterior_identified}.}
\end{figure}
