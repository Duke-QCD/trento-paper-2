...
Current efforts to realistically model the pre-equilibrium phase of the collision include calculations in both strong and weakly coupled limits \ref{?}, although the exact processes which drive rapid thermalization are not well understood.
...
The inelastic nucleon-nucleon participation probability, and hence the density of participant matter, can be calculated from a standard Glauber formalism \ref{?},
\begin{equation}
  P_\text{coll}(b) =
    1 - \exp\biggl[
