...
These initial conditions emerge from dynamical processes of the collision, and are commonly modeled in two stages: initial state models describe the system immediately after impact at time $\tau=0^+$, then pre-equilibrium transport models evolve the system until time $\tau=\tau_0$ when the system is assumed to have thermalized. The pre-equilibrium phase of the collision has been modeled by transport dynamics in both strongly and weakly coupled theories

Considerable effort has been devoted to understanding the processes responsible for rapid thermalization \cite{Romatschke:2006nk, Krasnitz:2002ng, Berges:2013eia, Arnold:2004ti, Kurkela:2011ti, Heller:2012km, vanderSchee:2013pia, Rebhan:2004ur, Heller:2011ju, Janik:2006gp} and models of the pre-equilibrium transport dynamics have been implemented in both strongly and weakly coupled limits \cite{Schenke:2012wb, Schenke:2012fw, vanderSchee:2013pia, vanderSchee:2015rta, Chesler:2015fpa}.
