...
As a partner to the distributions themselves, Fig.~\ref{fig:observables_samples} compares simulated observables (see Table~\ref{tab:observables}) to experimental data.
...
Overall, these plots show an excellent simultaneous fit to all observables.
