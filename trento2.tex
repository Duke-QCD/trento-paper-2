...
Bayesian methodology also provides a unique opportunity to parameterize and extract QGP initial conditionsi directly from data via systematic model to data comparison in order in order to resolve the apparent degeneracy in hydrodynamic initial condition models.


 and extract QGP initial conditions directly from experimental data. While parametric initial condition models are not a substitute , they
