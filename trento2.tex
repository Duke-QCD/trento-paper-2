...
Application of the Bayesian parameter estimation to heavy-ion collisions has been limited to simulations optimized with Monte Carlo Glauber (MC-Glb.) and Monte Carlo Kharzeev-Levin-Nardi (MC-KLN) initial conditons as well as first efforts to constrain the QGP initial conditions using a saturation inspired parameterization. 
