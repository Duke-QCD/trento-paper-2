...
The task of testing initial condition models is made even more challenging by the complex interplay of underconstrained initial state and QGP medium parameters. In order to assess the performance of the hydrodynamic model subject to given initial conditions, the parameters must be simultaneously optimized


 computational resources required to evaluate the model at a single point in parameter space. 
