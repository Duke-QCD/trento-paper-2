...
Figure~\ref{fig:etas_estimate} visualizes the complete estimate of the temperature dependence of $\eta/s$ via the median min and slope from the posterior (for identified particles) and a 90\% credible interval.
...
\subsection{Mode observables [interim title]}

Table~\ref{tab:mode_params}
